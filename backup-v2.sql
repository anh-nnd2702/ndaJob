...
--
-- Host: datn.mysql.database.azure.com    Database: ndajobv2
-- ------------------------------------------------------
...
--
-- Table structure for table `aplactivity`
--

DROP TABLE IF EXISTS `aplactivity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aplactivity` (
  ...
  KEY `aplActivity_fk_1_idx` (`applyId`),
  CONSTRAINT `aplActivity_fk_1` FOREIGN KEY (`applyId`) REFERENCES `appliedjob` (`applyId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aplactivity`
--

LOCK TABLES `aplactivity` WRITE;
/*!40000 ALTER TABLE `aplactivity` DISABLE KEYS */;
/*!40000 ALTER TABLE `aplactivity` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aplaward`
--

DROP TABLE IF EXISTS `aplaward`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aplaward` (
  ...
  `awardDescribe` text,
  PRIMARY KEY (`awardId`),
  KEY `aplAward_fk_1_idx` (`applyId`),
  CONSTRAINT `aplAward_fk_1` FOREIGN KEY (`applyId`) REFERENCES `appliedjob` (`applyId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aplaward`
--

LOCK TABLES `aplaward` WRITE;
/*!40000 ALTER TABLE `aplaward` DISABLE KEYS */;
/*!40000 ALTER TABLE `aplaward` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aplcertificate`
--

DROP TABLE IF EXISTS `aplcertificate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aplcertificate` (
  ...
  `certDescribe` text,
  PRIMARY KEY (`certId`),
  KEY `aplcertificate_fk-1_idx` (`applyId`),
  CONSTRAINT `aplcertificate_fk-1` FOREIGN KEY (`applyId`) REFERENCES `appliedjob` (`applyId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aplcertificate`
--

LOCK TABLES `aplcertificate` WRITE;
/*!40000 ALTER TABLE `aplcertificate` DISABLE KEYS */;
/*!40000 ALTER TABLE `aplcertificate` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `apleducation`
--

DROP TABLE IF EXISTS `apleducation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `apleducation` (
  ...
  `eduDescribe` text,
  PRIMARY KEY (`eduId`),
  KEY `apleducation_fk_1_idx` (`applyId`),
  KEY `apleducation_fk_2_idx` (`eduLevelId`),
  CONSTRAINT `apleducation_fk_1` FOREIGN KEY (`applyId`) REFERENCES `appliedjob` (`applyId`),
  CONSTRAINT `apleducation_fk_2` FOREIGN KEY (`eduLevelId`) REFERENCES `educationlevel` (`eduLevelId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `apleducation`
--

LOCK TABLES `apleducation` WRITE;
/*!40000 ALTER TABLE `apleducation` DISABLE KEYS */;
/*!40000 ALTER TABLE `apleducation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aplexperience`
--

DROP TABLE IF EXISTS `aplexperience`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aplexperience` (
  ...
  `experDescribe` text,
  PRIMARY KEY (`expId`),
  KEY `aplexp_fk_1_idx` (`applyid`),
  CONSTRAINT `aplexp_fk_1` FOREIGN KEY (`applyid`) REFERENCES `appliedjob` (`applyId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aplexperience`
--

LOCK TABLES `aplexperience` WRITE;
/*!40000 ALTER TABLE `aplexperience` DISABLE KEYS */;
/*!40000 ALTER TABLE `aplexperience` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aplproject`
--

DROP TABLE IF EXISTS `aplproject`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aplproject` (
  ...
  `prjDescribe` text,
  PRIMARY KEY (`prjId`),
  KEY `aplprj_fk_1_idx` (`applyId`),
  CONSTRAINT `aplprj_fk_1` FOREIGN KEY (`applyId`) REFERENCES `appliedjob` (`applyId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aplproject`
--

LOCK TABLES `aplproject` WRITE;
/*!40000 ALTER TABLE `aplproject` DISABLE KEYS */;
/*!40000 ALTER TABLE `aplproject` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aplskill`
--

DROP TABLE IF EXISTS `aplskill`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aplskill` (
  ...
  `skillDescribe` text,
  PRIMARY KEY (`skillId`),
  KEY `aplskill_fk_1_idx` (`applyId`),
  CONSTRAINT `aplskill_fk_1` FOREIGN KEY (`applyId`) REFERENCES `appliedjob` (`applyId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aplskill`
--

LOCK TABLES `aplskill` WRITE;
/*!40000 ALTER TABLE `aplskill` DISABLE KEYS */;
/*!40000 ALTER TABLE `aplskill` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `appliedjob` (
  ...
  `jobId` int NOT NULL,
  `coverLetter` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `applyTime` datetime NOT NULL,
  `applyStatus` int NOT NULL,
  `candId` int NOT NULL,
  `position` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvIntro` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `phoneNumber` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cityId` int NOT NULL,
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvImgUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`applyId`),
  KEY `jobId` (`jobId`),
  KEY `appliedjob_ibfk_2_idx` (`candId`),
  KEY `appliedjob_ibfk_3_idx` (`cityId`),
  CONSTRAINT `appliedjob_ibfk_1` FOREIGN KEY (`jobId`) REFERENCES `job` (`jobId`),
  CONSTRAINT `appliedjob_ibfk_2` FOREIGN KEY (`candId`) REFERENCES `candidates` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `appliedjob_ibfk_3` FOREIGN KEY (`cityId`) REFERENCES `city` (`cityId`)
...
CREATE TABLE `company` (
  ...
  `companyIntro` text COLLATE utf8mb4_unicode_ci,
  `companyPhone` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `companyLogo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'https://drive.google.com/uc?export=view&id=1WaXr3NCH6M8_xdwwwYiNNXpgvoMjlFTl',
  `companyLink` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `companyPass` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `cv` (
  ...
  `cvTitle` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `candId` int NOT NULL,
  `cvPosition` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `workFieldId` int NOT NULL,
  `cvIntro` text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `cityId` int NOT NULL,
  `address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cvImgUrl` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `cvactivity`
--

DROP TABLE IF EXISTS `cvactivity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cvactivity` (
  `activityId` int NOT NULL AUTO_INCREMENT,
  `cvId` int NOT NULL,
  `activityName` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`activityId`),
  KEY `cvId` (`cvId`),
  CONSTRAINT `cvactivity_ibfk_1` FOREIGN KEY (`cvId`) REFERENCES `cv` (`cvId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cvactivity`
--

LOCK TABLES `cvactivity` WRITE;
/*!40000 ALTER TABLE `cvactivity` DISABLE KEYS */;
/*!40000 ALTER TABLE `cvactivity` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cvaward`
--

DROP TABLE IF EXISTS `cvaward`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cvaward` (
  `awardId` int NOT NULL AUTO_INCREMENT,
  `cvId` int NOT NULL,
  `awardTitle` varchar(255) NOT NULL,
  `organization` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`awardId`),
  KEY `cvId` (`cvId`),
  CONSTRAINT `cvaward_ibfk_1` FOREIGN KEY (`cvId`) REFERENCES `cv` (`cvId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cvaward`
--

LOCK TABLES `cvaward` WRITE;
/*!40000 ALTER TABLE `cvaward` DISABLE KEYS */;
/*!40000 ALTER TABLE `cvaward` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cvcertificate` (
  `certId` int NOT NULL AUTO_INCREMENT,
  `cvId` int NOT NULL,
  `certTitle` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `organization` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `certDate` date NOT NULL,
  `expireDate` date DEFAULT NULL,
  `certDescribe` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`certId`),
  KEY `cvId` (`cvId`),
...
CREATE TABLE `cveducation` (
  ...
  `startDate` date NOT NULL,
  `endDate` date DEFAULT NULL,
  `eduDescribe` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`eduId`),
  KEY `cvId` (`cvId`),
...
CREATE TABLE `cvexperience` (
  ...
  `startDate` date NOT NULL,
  `endDate` date DEFAULT NULL,
  `experDescribe` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`experId`),
  KEY `cvId` (`cvId`),
...
CREATE TABLE `cvproject` (
  `prjId` int NOT NULL AUTO_INCREMENT,
  `prjName` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cvId` int NOT NULL,
  `teamSize` int DEFAULT NULL,
  `startDate` date DEFAULT NULL,
  `endDate` date DEFAULT NULL,
  `prjPosition` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prjDescribe` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`prjId`),
  KEY `cvId` (`cvId`),
...
CREATE TABLE `cvskill` (
  ...
  `skillLevel` int NOT NULL,
  `skillDescribe` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`skillId`),
  KEY `cvId` (`cvId`),
...
CREATE TABLE `educationlevel` (
  `eduLevelId` int NOT NULL,
  `eduLevelName` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `job` (
  ...
  `workAddress` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `modifiedTime` datetime NOT NULL,
  `cityId` int NOT NULL,
  `jobDescribe` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `eduLevelId` int NOT NULL,
  ...
  `workFieldId` int NOT NULL,
  `jobRequire` text COLLATE utf8mb4_unicode_ci,
  `jobBenefit` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`jobId`),
...
CREATE TABLE `jobtype` (
  `jobTypeId` int NOT NULL,
  `jobTypeName` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `reportjob` (
  ...
  `candId` int NOT NULL,
  `jobId` int NOT NULL,
  `reportDescribe` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `workfield` (
  `workFieldId` int NOT NULL,
  `workFieldName` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `worklevel` (
  `workLevelId` int NOT NULL,
  `workLevelName` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2023-07-21 12:37:24
